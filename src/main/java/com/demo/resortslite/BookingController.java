...
public class BookingController {
    ...
    public Map<String, Object> createBooking(
        ...
        if (sessionId != null && !sessionId.isEmpty()) {
            ...
            redisTemplate.opsForValue().set(sessionKey, booking, cacheTtl, TimeUnit.MILLISECONDS);
            redisTemplate.opsForValue().set(guestKey, guestName, cacheTtl, TimeUnit.MILLISECONDS);
        }
    ...
    public Map<String, Object> downloadReport(@RequestParam String month) {
        ...
        String reportPath = "gs://" + storageBucket + "/reports/" + month + "_bookings.pdf";
